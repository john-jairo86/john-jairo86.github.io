...
function init() {
    ...
    const datosIniciales = {
        int: [
            ...
            "Sin Internet con luz roja los, reset eléctrico modem se verifica en sistema y vemos perdida de señal luz los, se verifica en twister y vemos que no hay mas clientes afectados",
...
function renderLista(tipo, lista) {
    ...
    lista.forEach(txt => {
        ...
        btnEdit.innerHTML = "✏️"; // Usar innerHTML para asegurar que el emoji cargue bien
